          ...
          <div className="hidden lg:flex space-x-4" style={{}}>
            <ul className="flex space-x-4">
              ...
              {token ? (
                <>
                  <li>
                    <Link className="hover:text-gray-700" to="/matching">
                      Matching
                    </Link>
                  </li>
                  <li>
                    <Link className="hover:text-gray-700" to="/chats">
                      Chat
                    </Link>
                  </li>
                  <li>
            ...
            <ul className="flex space-x-4">
              {token ? (
                <li>
                  <Link
                    className="hover:bg-black text-green-500 px-4 py-2 rounded-full"
                    to="/search"
                  >
                    Search
                  </Link>
              ...
              {!token ? (
                <>
                  ...
                  <li>
                    <Link
                      className="bg-black hover:bg-green-600 text-white px-4 py-2 rounded-full"
                      to="/register"
                    >
                      Register
                    </Link>
                ...
                <li className="relative" onClick={toggleDropdown}>
                  ...
                  <ul
                    className={`dropdown-menu absolute text-gray-700 bg-white shadow-lg rounded-md mt-2 py-1 ${
